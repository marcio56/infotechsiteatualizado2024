        ...
        <div class="mx-auto col-10">
            <form class="row my-3" method="POST" action="../../routes.php">
                ...
                <div class="mb-3 col-6">
                    ...
                    <input type="text" value="" name="cpf" class="form-control" id="cpf">
                </div>
                <div class="mb-3 col-6">
                    <label for="birthdate" class="form-label">Data de nascimento</label>
                    <input type="date" value="" name="birthdate" class="form-control" id="birthdate">
                </div>
                <div class="mb-3 col-6">
                    <label for="birthplace" class="form-label">Naturalidade</label>
                    <input type="text" value="" name="birthplace" class="form-control" id="birthplace">
                </div>
                <div class="mb-3 col-6">
                    <label for="nationality" class="form-label">Nacionalidade</label>
                    <input type="text" value="" name="nationality" class="form-control" id="nationality">
                </div>
                <div class="mb-3 col-6">

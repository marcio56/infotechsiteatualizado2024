...
<body class="bg-light">
    <main class="container vh-100 d-flex align-items-center">
        ...
        <form method="POST" action="../../routes.php" class="card p-5">
            <h1 class="h3 mb-3 fw-bold">Criar sua conta</h1>
            ...
            <button class="w-100 btn btn-lg btn-primary mt-3 fw-bold" type="submit">Criar</button>
            <a class="mt-3" href="login.php">Acessar conta</a>

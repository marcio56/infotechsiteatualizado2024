      ...
      <div class="app-main">
        <div class="video-call-wrapper">
          ...
          <div class="video-participant">
            ...
            <a href="#" class="name-tag">Charlinho</a>
            <img
          ...
          <div class="video-participant">
            ...
            <a href="#" class="name-tag">Judite Maria</a>
            <img
          ...
          <div class="video-participant">
            ...
            <a href="#" class="name-tag">Carlito Tevez</a>
            <img
          ...
          <div class="video-participant">
            ...
            <a href="#" class="name-tag">Bebel Gagau</a>
            <img
          ...
          <div class="video-participant">
            ...
            <a href="#" class="name-tag">Gustavo PQP</a>
            <img
          ...
          <div class="video-participant">
            ...
            <a href="#" class="name-tag">Raimunda do B</a>
            <img
      ...
      <div class="right-side">
        ...
        <div class="chat-container">
          <div class="chat-header">
            <button class="chat-header-button">Bate-Papo ao Vivo</button>
          </div>
          <div class="chat-area">
            <!-- Message 1 -->
            <div class="message-wrapper">
              ...
              <div class="message-content">
                <p class="name">Gustavo PQP</p>
                <div class="message">Dale rapazeada!😍</div>
              </div>
            </div>
            <!-- Message 2 -->
            <div class="message-wrapper">
              ...
              <div class="message-content">
                <p class="name">Charlinho</p>
                <div class="message">
                  Podem me ouvir?🤯 <a class="mention">@GustavoPQP</a>
                </div>
              </div>
            </div>
            <!-- Message 3 -->
            <div class="message-wrapper">
              ...
              <div class="message-content">
                <p class="name">Bebel Gagau</p>
                <div class="message">Vamos lá! Gente, Começar.</div>
              </div>
            </div>
            <!-- Message 4 -->
            <div class="message-wrapper reverse">
              ...
              <div class="message-content">
                <p class="name">Judite Maria</p>
                <div class="message">Bom dia Cuecas!🌈</div>
              </div>
            </div>
            <!-- Message 5 -->
            <div class="message-wrapper">
              ...
              <div class="message-content">
                <p class="name">Carlito Tevez</p>
                <div class="message">Olha esse novo Doc⬇️</div>
                <div class="message-file">
                  ...
                  <div class="file-info">
                    <div class="file-name">AnoNovo2024.sketch</div>
            ...
            <div class="message-wrapper">
              ...
              <div class="message-content">
                <p class="name">Gustavo PQP</p>
                <div class="message">Beleza!❤️</div>
                <div class="message">
                  Baixei o arquivo <a class="mention">@carlitotevez</a>
                </div>
              </div>
            </div>
            ...
            <div class="message-wrapper reverse">
              ...
              <div class="message-content">
                <p class="name">Judite Maria</p>
                <div class="message">Woooww! Incrível❤️</div>
              </div>
            </div>
          </div>

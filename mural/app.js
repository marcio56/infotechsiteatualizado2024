...
function timeTableAll(){
    ...
    setData(today);
    document.querySelector('.timetable div h2').innerHTML = "Horário das Aulas";
}
...
document.querySelector('.timetable div h2').innerHTML = "Horário das Aulas"; //To prevent overwriting the heading on loading;
